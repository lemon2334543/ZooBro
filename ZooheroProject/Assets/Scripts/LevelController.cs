...
public class LevelController : MonoBehaviour
{
    ...
    //     {
    //         // Debug.Log("Prefabs/Waepons/"+ weapon.familyname +"/"+ weapon.name);
    //         GameObject gameObject = UnityEngine.Resources.Load<GameObject>("Prefabs/Waepons/"+ weapon.familyname +"/"+ weapon.EnName);
