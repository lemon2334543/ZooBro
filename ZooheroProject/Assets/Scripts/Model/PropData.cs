...
public class PropData : ItemData
{
    ...
    // 游戏性相关
    public int harvest = 0;            // 收获（额外资源获取）                    弃用
    ...
    public float FreeRefreshes = 0;         // 大富翁（影响金币获取倍率百分比）
}